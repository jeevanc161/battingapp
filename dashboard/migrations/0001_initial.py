    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('account_created_time', models.TimeField(auto_now_add=True, null=True)),
                ...
                ('aadhar_card', models.FileField(blank=True, null=True, upload_to='uploads/')),
                ('pen_card', models.FileField(blank=True, null=True, upload_to='uploads/')),
                ('bank_passbook', models.FileField(blank=True, null=True, upload_to='uploads/')),
